...
public record SyncPacketN(JsonMap map) implements CustomPacketPayload {
	...
	public static SyncPacketN read(FriendlyByteBuf buf){
		return new SyncPacketN(JsonHandler.parse(buf.readUtf(buf.readInt()), true).asMap());
	}
